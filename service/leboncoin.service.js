...
const getDataFromLeboncoinDOM = () => {
    ...
    const body2 = document.querySelector("#grid > article > section > div.css-1eifrgn > div:nth-child(3) > div")
    const price = document.querySelector('[data-qa-id=adview_price] > span')
    const renter = document.querySelector("#aside > section > div[data-qa-id=adview_contact_container] > div h2") || document.querySelector("#aside > section > div[data-qa-id=adview_contact_container] > div > div > div > a")
    ...
    const cityLabel = document.querySelector("#grid > article > div._3JOrc._1akwr._1mwQl.aj3_W.FB92D._3qvnf.PYBnx.rvrtO._23jKN._2hbpZ._1_1QY._1qvhT")
